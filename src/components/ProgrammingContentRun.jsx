...
const ProgrammingContentRun = () => {
  return (
    <div className='code-executed'>
    <h2>Programming</h2> 
    <p className='content'>My journey into programming began with a spark of curiosity that ignited into a passionate love affair with code.
...
export default ProgrammingContentRun
