  ...
  return (
    <div className="code-executed">
      ...
      <p className="content">
        ...
        <br />
        <br />
        Playing games got me thinking, "Hey, why not make my own?" So, I started
        to explore game development. It's like being the boss of your own
        adventure, creating worlds and stories for others to enjoy. Playing
        games was fun, but making them? That's a whole new level of awesome.
        <br />
        <br />
